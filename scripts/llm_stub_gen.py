...
# Output
Respond only with the generated .pyi stub code. Do not include markdown formatting (such as codeblocks), explanations, or filenames.
"""
...
def generate_stubs(symbol_code:str, cython_source_code: str) -> str:
    ...
    response = litellm.completion(
        model="openrouter/openai/gpt-oss-120b", #"gemini/gemini-2.5-flash", # "openrouter/qwen/qwen3-32b", # "openrouter/deepseek/deepseek-r1-0528"
        messages=[{
            "role": "user", 
            "content": prompt,
        }],
