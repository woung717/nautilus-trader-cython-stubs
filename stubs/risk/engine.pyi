...
class RiskEngine(Component):
    ...
    def _check_orders_risk_for_account(self, instrument: Instrument, orders: list[Order], account_id: AccountId) -> bool: ...
    def _check_price(self, instrument: Instrument, price: Price | None) -> str | None: ...
    def _check_quantity(self, instrument: Instrument, quantity: Quantity, is_quote_quantity: bool=False) -> str | None: ...
