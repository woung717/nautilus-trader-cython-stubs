...
class ExecutionEngine(Component):
    ...
    def _find_client_for_command(self, command: Command) -> ExecutionClient: ...
    ...
    def _determine_position_id(self, fill: OrderFilled,oms_type: OmsType, order: Order=None) -> None: ...
    def _determine_hedging_position_id(self, fill: OrderFilled, order: Order=None) -> PositionId: ...
    def _purge_closed_orders(self, event: TimeEvent) -> None: ...
    def _purge_closed_positions(self, event: TimeEvent) -> None: ...
    def _purge_account_events(self, event: TimeEvent) -> None: ...
    def _determine_netting_position_id(self, fill: OrderFilled) -> PositionId: ...
    def _apply_event_to_order(self, order: Order, event: OrderEvent) -> bool: ...
    def _handle_order_fill(self, order: Order, fill: OrderFilled, oms_type: OmsType) -> None: ...
    def _open_position(self, instrument: Instrument, position: Position, fill: OrderFilled, oms_type: OmsType) -> None: ...
    def _reopen_position(self, position: Position, oms_type: OmsType) -> None: ...
